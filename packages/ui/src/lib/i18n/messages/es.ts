...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.connect.error.tunnelPasswordUnsupported": "Este enlace del servidor solo admite acceso temporal por tunnel. Ábrelo desde el enlace de la app de escritorio.",
  "mobile.connect.error.rateLimited": "Se intentó desbloquear demasiadas veces. Espera un momento y vuelve a intentarlo.",
  "mobile.connect.error.unlockFailed": "No se pudo desbloquear ese servidor. Inténtalo de nuevo o revisa la configuración del servidor.",
  ...
  "chat.chatInput.contextLimit.title": "Uso de contexto alto",
  "chat.chatInput.contextLimit.description": "Esta sesión ha utilizado {tokens} tokens ({percentage}% del límite de contexto). Enviar otro mensaje aumentará los costos y podría degradar la calidad de la respuesta.",
  "chat.chatInput.contextLimit.cancel": "Cancelar",
  "chat.chatInput.contextLimit.confirm": "Enviar de todos modos",
