...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.error.tunnelPasswordUnsupported': '此伺服器連結僅支援一次性 tunnel 存取。請改用桌面應用程式提供的連結開啟。',
  'mobile.connect.error.rateLimited': '解鎖嘗試次數過多。請稍後再試。',
  'mobile.connect.error.unlockFailed': '無法解鎖該伺服器。請重試或檢查伺服器設定。',
  ...
  'chat.chatInput.contextLimit.title': '上下文使用率較高',
  'chat.chatInput.contextLimit.description': '此會話已使用 {tokens} tokens（佔上下文限制的 {percentage}%）。繼續發送訊息將增加成本，並可能降低回應品質。',
  'chat.chatInput.contextLimit.cancel': '取消',
  'chat.chatInput.contextLimit.confirm': '仍然發送',
