...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.error.tunnelPasswordUnsupported': '이 서버 링크는 일회성 tunnel 접근만 지원합니다. 데스크톱 앱에서 제공한 링크로 여세요.',
  'mobile.connect.error.rateLimited': '잠금 해제 시도가 너무 많습니다. 잠시 후 다시 시도하세요.',
  'mobile.connect.error.unlockFailed': '서버 잠금을 해제할 수 없습니다. 다시 시도하거나 서버 설정을 확인하세요.',
  ...
  'chat.chatInput.contextLimit.title': '컨텍스트 사용량 높음',
  'chat.chatInput.contextLimit.description': '이 세션은 {tokens} 토큰을 사용했습니다 (컨텍스트 제한의 {percentage}%). 메시지를 더 보내면 비용이 증가하고 응답 품질이 저하될 수 있습니다.',
  'chat.chatInput.contextLimit.cancel': '취소',
  'chat.chatInput.contextLimit.confirm': '그래도 보내기',
