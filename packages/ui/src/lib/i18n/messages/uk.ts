...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.connect.error.tunnelPasswordUnsupported": "Це посилання на сервер підтримує лише одноразовий доступ через tunnel. Відкрий його з посилання, яке надав desktop-застосунок.",
  "mobile.connect.error.rateLimited": "Забагато спроб розблокування. Зачекай трохи й спробуй ще раз.",
  "mobile.connect.error.unlockFailed": "Не вдалося розблокувати сервер. Спробуй ще раз або перевір налаштування сервера.",
  ...
  "chat.chatInput.contextLimit.title": "Високе використання контексту",
  "chat.chatInput.contextLimit.description": "Ця сесія використала {tokens} токенів ({percentage}% ліміту контексту). Надсилання ще одного повідомлення збільшить витрати та може погіршити якість відповіді.",
  "chat.chatInput.contextLimit.cancel": "Скасувати",
  "chat.chatInput.contextLimit.confirm": "Все одно надіслати",
