...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.error.tunnelPasswordUnsupported': '该服务器链接仅支持一次性隧道访问。请改用桌面端提供的链接打开。',
  'mobile.connect.error.rateLimited': '解锁尝试次数过多。请稍等后再试。',
  'mobile.connect.error.unlockFailed': '无法解锁该服务器。请重试或检查服务器设置。',
  ...
  'chat.chatInput.contextLimit.title': '上下文使用率较高',
  'chat.chatInput.contextLimit.description': '此会话已使用 {tokens} tokens（占上下文限制的 {percentage}%）。继续发送消息将增加成本，并可能降低响应质量。',
  'chat.chatInput.contextLimit.cancel': '取消',
  'chat.chatInput.contextLimit.confirm': '仍然发送',
