...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "mobile.connect.error.tunnelPasswordUnsupported": "Este link do servidor só aceita acesso tunnel de uso único. Abra-o pelo link fornecido no app desktop.",
  "mobile.connect.error.rateLimited": "Houve tentativas demais de desbloqueio. Aguarde um momento e tente novamente.",
  "mobile.connect.error.unlockFailed": "Não foi possível desbloquear esse servidor. Tente novamente ou confira as configurações do servidor.",
  ...
  "chat.chatInput.contextLimit.title": "Alto uso de contexto",
  "chat.chatInput.contextLimit.description": "Esta sessão usou {tokens} tokens ({percentage}% do limite de contexto). Enviar outra mensagem aumentará os custos e poderá degradar a qualidade da resposta.",
  "chat.chatInput.contextLimit.cancel": "Cancelar",
  "chat.chatInput.contextLimit.confirm": "Enviar mesmo assim",
