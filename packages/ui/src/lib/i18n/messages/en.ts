...
export const dict = {
  ...
  'mobile.connect.error.tunnelPasswordUnsupported': 'This server link only supports one-time tunnel access. Open it from the desktop app link instead.',
  'mobile.connect.error.rateLimited': 'Too many unlock attempts. Wait a moment and try again.',
  'mobile.connect.error.unlockFailed': 'Could not unlock that server. Try again or verify the server settings.',
  ...
  'chat.chatInput.contextLimit.title': 'Context Usage High',
  'chat.chatInput.contextLimit.description': 'This session has used {tokens} tokens ({percentage}% of context limit). Sending another message will increase costs and may degrade response quality.',
  'chat.chatInput.contextLimit.cancel': 'Cancel',
  'chat.chatInput.contextLimit.confirm': 'Send Anyway',
