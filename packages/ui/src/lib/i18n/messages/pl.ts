...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.error.tunnelPasswordUnsupported': 'Ten link do serwera obsługuje tylko jednorazowy dostęp przez tunnel. Otwórz go z linku udostępnionego w aplikacji desktopowej.',
  'mobile.connect.error.rateLimited': 'Zbyt wiele prób odblokowania. Poczekaj chwilę i spróbuj ponownie.',
  'mobile.connect.error.unlockFailed': 'Nie udało się odblokować tego serwera. Spróbuj ponownie lub sprawdź ustawienia serwera.',
  ...
  'chat.chatInput.contextLimit.title': 'Wysokie użycie kontekstu',
  'chat.chatInput.contextLimit.description': 'Ta sesja użyła {tokens} tokenów ({percentage}% limitu kontekstu). Wysłanie kolejnej wiadomości zwiększy koszty i może obniżyć jakość odpowiedzi.',
  'chat.chatInput.contextLimit.cancel': 'Anuluj',
  'chat.chatInput.contextLimit.confirm': 'Mimo to wyślij',
